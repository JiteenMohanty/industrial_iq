 ...
 * compare against. `scope.repId` extends this the same way for the rep detail page's funnel
 * (FR-024) — additive, not a deviation from the analytics-api.md contract's documented signature.
 */
